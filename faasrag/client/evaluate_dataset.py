...
def main(cfg: RagServiceConfig):
    ...
    parser.add_argument("--logit_bias_strength", type=str, default="1000000")
    parser.add_argument("--max_token_logit_bias", type=str, default="100000")  # effectively no cap by default
