...
from pwrag.evaluator.utils import normalize_answer
...
class BaseMetric:
    ...
    def __init__(self, config:AppConfig):
        self.config = config
        self.dataset_name = config.dataset.dataset_name if config.dataset.dataset_name is not None else "unknown"
...
#         from pwrag.utils.constants import OPENAI_MODEL_DICT
